var swiper = new Swiper('.swiper-container', {
  ...
  // var x = document.querySelector(".group-video .active").innerHTML;
  var x = $( ".group-video .active" ).text();
  console.log(x);
  ...
  document.querySelector("#play-it").setAttribute('src', "./foto/wwdfoto/"+ x);
  ...
  $(document).ready(function(){
    $(".button-switch-video").on('click', function(e) {
      // x = document.querySelector(".group-video .active").innerHTML;
      x = $( ".group-video .active" ).text();
      document.querySelector("#what-we-do .mask2 .text").innerHTML = "<i class=\"fas fa-arrow-left\"></i> "+x + "&nbsp; &nbsp;";  
      // document.querySelector("#play-it").src = "./asset/video/"+ x;  
      document.querySelector("#play-it").setAttribute('src', "./foto/wwdfoto/"+ x);
      document.querySelector("#tmplt-play-it").load();
